...
2. **VCG payments**: 
   ...
   * assignment 5
3. **payment identity (single-parameter domains):** ![image 1](payment%20identity.png){size=medium}
   * assignment 6
4. **GSP / position auctions**
...
5. **eBay / second price style price rule:** ![image 1](eBay_second%20price%20style%20price%20rule.png){size=medium}
6. **scoring rules:**
   ...
   * assignment 10
7. **conditional probability (peer prediction):** ![image 1](conditional%20prob%20peer_predict.png){size=medium}
   * assignment 10
8. **market scoring rule (prediction markets):**
...
9. **greedy / knapsack ranking:** ![image 1](greed_knapsack%20ranking.png){size=small}
